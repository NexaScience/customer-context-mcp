...
class Config:
    ...
    # Slack bot token (xoxb-). The Slack source scans the history of channels the
    # bot is a member of, so it needs channels:read, groups:read, channels:history
    # and groups:history scopes.
